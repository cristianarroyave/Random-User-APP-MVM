            ...
            Column {
                Row (modifier = Modifier
                    ...
                    Image(
                        modifier = Modifier
                            .size(90.dp),
                        painter = rememberImagePainter(data = "https://randomuser.me/api/portraits/men/34.jpg",
                            builder = {
                                placeholder(R.drawable.placeholder)
                                error(R.drawable.placeholder)
                            }
                ...
                Text("culo", textAlign = TextAlign.Left, modifier = Modifier
                    .padding(start = 20.dp), style = TextStyle(
                    fontSize = 16.sp,
                    fontFamily = FontFamily.Monospace,
                    fontWeight = FontWeight.W800,
                ...
                Text("tetas", textAlign = TextAlign.Left, modifier = Modifier
                    .padding(start = 20.dp), style = TextStyle(
                    fontSize = 16.sp,
                    fontFamily = FontFamily.Monospace,
                    fontWeight = FontWeight.W800,
                ...
                Text("caca", textAlign = TextAlign.Left, modifier = Modifier
                    .padding(start = 20.dp), style = TextStyle(
                    fontSize = 16.sp,
                    fontFamily = FontFamily.Monospace,
                    fontWeight = FontWeight.W800,
                ...
                Text("caca 2", textAlign = TextAlign.Left, modifier = Modifier
                    .padding(start = 20.dp), style = TextStyle(
                    fontSize = 16.sp,
                    fontFamily = FontFamily.Monospace,
                    fontWeight = FontWeight.W800,
